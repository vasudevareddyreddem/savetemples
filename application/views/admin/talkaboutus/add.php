...
<section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">Add Talk about us</li>
      </ol>
    </section>
        ...
        <div class="col-md-12">
          ...
          <div class="box box-primary">
            <div class="box-header with-border">
              <h3 class="box-title">Add Talk about us</h3>
            </div>
            <!-- /.box-header -->
            <!-- form start -->
			<div style="padding:20px;">
            <form id="addfaq" method="post" class="" action="<?php echo base_url('talkaboutus/addpost'); ?>" enctype="multipart/form-data">
					<?php $csrf = array(
						...
						<div class="col-md-8">
							<div class="form-group">
								...
								<div class="">
									<input type="text" class="form-control" name="category" id="category" value="" placeholder="ex:Team Leader" />
								</div>
							</div>
                        </div>

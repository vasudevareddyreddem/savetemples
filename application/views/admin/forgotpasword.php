...
<div class="login-box">
  ...
  <div class="login-box-body">
    <p class="login-box-msg">Forgot Password</p>
						...
						<div class="">
							<form id="defaultForm" name="defaultForm" method="post" class="" action="<?php echo base_url('admin/forgotpost'); ?>">
						  ...
						  <div class="form-group">
							...
							<div class="col-md-6">
                                <button type="submit" class="btn btn-primary pull-right" name="signup" value="Sign up">Forgot</button>

      ...
      <div class="row">
        ...
        <div class="col-md-12">
          ...
          <div class="box box-primary">
            ...
            <form id="addfaq" method="post" class="" action="<?php echo base_url('event/editpost'); ?>" enctype="multipart/form-data">
					<?php $csrf = array(
								'name' => $this->security->get_csrf_token_name(),
								'hash' => $this->security->get_csrf_hash()
						); ?>
						<input type="hidden" name="<?=$csrf['name'];?>" value="<?=$csrf['hash'];?>" />
						<input type="hidden" name="e_id" value="<?php echo isset($details['e_id'])?$details['e_id']:''; ?>" />
							...
							<div class="form-group">
								...
								<div class="">
									 <select class="form-control" id="type" name="type">
									  ...
									  <option value="Upcoming" <?php if($details['type']=='Upcoming'){ echo "selected"; } ?>>Upcoming</option>
									  <option value="Previous" <?php if($details['type']=='Previous'){ echo "selected"; } ?>>Previous</option>
									</select>
								</div>
							</div>
                        </div>

      ...
      <div class="row">
        ...
        <div class="col-md-12">
          ...
          <div class="box box-primary">
            ...
            <form id="addfaq" method="post" class="" action="<?php echo base_url('event/addpost'); ?>" enctype="multipart/form-data">
					<?php $csrf = array(
						...
						<div class="col-md-8">
							<div class="form-group">
								...
								<div class="">
									<input type="text" class="form-control" name="date" id="date" value="" placeholder="14-07-1992" />
								</div>
							</div>
                        </div>
